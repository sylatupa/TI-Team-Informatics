...
2) Run AdasEmotiv.jar; you have to choose to connect to the headset (and read ONLY emotions). This will connect with the with the headset.
...
5) Run the AdasTester.jar to try and test this piece of software. This is a slim client that connects to the sockets generated for the prior two applications (AdasEmotiv and AdasPAD), using this cliente you can see the information that is that is been sent through the three sockets mentioned above.
